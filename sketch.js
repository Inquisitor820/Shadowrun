...
function preload()
{
   ...
   gameMusic = loadSound("sounds/Custom Game Track1.mp3")
...
//platforms
 ...
 obj = createSprite(-2300, -60, 10 , 500)
 obj.visible= false;
...
{ 
    ...
    //victory.play();
     ...
     text('Congratulations! You Won!!',-450,-450);
 }
 ...
 { 
    gameMusic.stop()
     ...
     strokeWeight(1.5)
     textFont("courier new")
     text('You were sent to oblivion by the Gloomaxi...',-1300,-450);
 }
}
